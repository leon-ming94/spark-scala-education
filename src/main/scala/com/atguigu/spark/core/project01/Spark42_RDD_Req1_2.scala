...
//id,click -> num id,order -> num
class MyCategoryCountAccumulator2 extends AccumulatorV2[UserVisitAction, mutable.HashMap[(String, String), Long]] {
    ...
    override def copy(): AccumulatorV2[UserVisitAction, mutable.HashMap[(String, String), Long]] = {
        new MyCategoryCountAccumulator2
    }
    ...
    override def value: mutable.HashMap[(String, String), Long] = map
}
